...
function ContactForm() {
  return (
    <div className="flex flex-col p-4 lg:px-10 lg:py-12 bg-gradient-to-r from-gray-800 to-gray-900 shadow-[10px_10px_20px_rgba(0,0,0,0.5),_-10px_-10px_20px_rgba(255,255,255,0.05)] group rounded-lg text-white">
